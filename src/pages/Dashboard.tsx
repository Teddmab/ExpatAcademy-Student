        ...
        <div className="mt-8">
          ...
          <div className="mt-4 bg-white shadow rounded-lg">
            <ul className="divide-y divide-gray-200">
              {[
                { title: 'Completed Module 3 in Advanced JavaScript', date: '2 hours ago' },
                { title: 'Started Python for Data Science', date: 'Yesterday' },
                { title: 'Earned JavaScript Fundamentals Certificate', date: '3 days ago' },
              ].map((activity, index) => (
